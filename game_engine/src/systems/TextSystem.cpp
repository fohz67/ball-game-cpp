 ...
 *
 * This function checks if the text component is loaded. If not, it loads the
 * font from file, sets the font, string, character size, position, and color of
 * the text. Finally, it marks the text component as loaded. If the text
 * component is already loaded, it updates the text.
 *
 ...
 *
 * This function checks if the entity has both text and position components. If
 * so, it loads the text component and then draws the text on the window. If the
 * position component has multiple positions, it draws the text at each
 * position. Otherwise, it draws the text at the single position.
 *
